...
import { FaTachometerAlt, FaPenNib, FaPalette, FaShapes, FaIcons, FaBook, FaBars, FaSignOutAlt } from 'react-icons/fa';

const DashboardPage = () => <div className="p-4">Dashboard Content</div>;
const TypographyPage = () => <div className="p-4 min-h-screen bg-black">Typography Content</div>;
const ColorPage = () => <div className="p-4 min-h-screen bg-blue-500">Color Content</div>;
const ShadowPage = () => <div className="p-4 min-h-screen bg-red-500">Shadow Content</div>;
const IconsPage = () => <div className="p-4 min-h-screen bg-green-500">Icons Content</div>;
const SamplePage = () => <div className="p-4 min-h-screen bg-yellow-500">Sample Page Content</div>;
      ...
      <div className="flex flex-col h-screen">
        ...
        <header className="bg-white shadow flex items-center justify-between p-4 w-full">
          <div className="flex items-center space-x-2">
            ...
            <div className="text-2xl font-bold">Student Event Attendance Management</div>
          </div>
          <div className="flex items-center space-x-2">
            <input
              type="text"
