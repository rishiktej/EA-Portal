    ...
    <div className="min-h-screen flex items-center justify-center bg-blue-100 p-4 sm:p-8">
      <div className="bg-white p-6 sm:p-8 rounded-lg shadow-lg max-w-sm sm:max-w-md w-full">
        <div className="flex flex-col items-center mb-6">
          ...
          <h2 className="text-xl sm:text-2xl font-semibold text-purple-600">Login</h2>
            ...
            <div className="relative">
              ...
              <button
                ...
                <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 12h.01M12 15h.01M9 12h.01M12 9h.01M17 16v1M17 16v1a2 2 0 01-2 2h-6a2 2 0 01-2-2v-1M15 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                </svg>
              </button>
            </div>
          </div>
        ...
        <div className="mt-6 text-center text-gray-500 text-sm">
          Student Event Attendance Management <a href="#" className="text-purple-600 underline hover:text-indigo-500">know More</a>
        </div>
      </div>
